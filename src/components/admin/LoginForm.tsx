    ...
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-16">
      <div className="rounded-xl border border-ink/10 bg-white p-8 shadow-sm">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-md border border-ink/20 bg-white px-4 py-2.5 text-sm font-semibold text-ink transition-colors hover:border-ink/40"
        >
